...
- `org.jetbrains.kotlinx:kotlinx-io-core` ([Latest version](https://central.sonatype.com/artifact/org.jetbrains.kotlinx/kotlinx-io-core))
- `gr.elaevents.buffela.schema:utils` ([Latest version](https://central.sonatype.com/artifact/gr.elaevents.buffela.schema/utils))
...
You can read the buffela schema however you need to, depending on the format. If it is yaml, you need either a library to parse it (like [yaml](https://www.npmjs.com/package/yaml)), or to convert it to json first for easy importing.
