...
yargs()
    .command({
        command: 'generate <schema> [destination]',
        aliases: ['gen'],
        describe: 'Generate kotlin classes for a buffela schema',
        builder: (yargs) => yargs
            .positional('schema', {
                describe: 'The buffela schema path',
                type: 'string'
            })
        ...
        handler: (argv) => {
            ...
            printer.line("// Auto-generated by buffela-to-kotlin, DO NOT MODIFY")
    ...
    .command({
        ...
        handler: (argv) => {
            const outputStream = fileUtils.getFileOutputStream(argv.destination, "buffela.json")
